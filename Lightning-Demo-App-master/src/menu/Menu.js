export default class Menu extends lng.Component{
    ...
    _init(){
        ...
        const liveTv = this.stage.c({
            type: MenuItem, item:{label:"LiveTv", ref:"LiveTv"}
        });

        // const comingSoon = this.stage.c({
        //     type: MenuItem, item:{label:"comingSoon", ref:"comingSoon"}
        // });

        this.childList.add(shows);
        this.childList.add(liveTv);
    }
